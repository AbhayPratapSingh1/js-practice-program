...
const strings = [
  ...method in JavaScript, when used with arrays, does not modify the original array(s). Instead, it returns a new array containing the combined elements of the original array and any arrays or values passed as arguments."method in JavaScript, when used with arrays, does not modify the original array(s). Instead, it returns a new array containing the combined elements of the original array and any arrays or values passed as arguments."
    .split(" "),
];
