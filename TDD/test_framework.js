...
function findMaxLen(entity1, entity2, expected, actual) {
  ...
  maxLenEntityExpected = max("" * expected, maxLenEntityExpected) + sideGap;
...
function setRow(entity1, entity2, expected, actual) {
  ...
  message += addSpaces(expected, maxLenEntityExpected) + resetPrefix + "|";
